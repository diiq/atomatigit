...
class RepoView extends View
  ...
  insert_commands: ->
    ...
    atom.workspaceView.command "atomatigit:stash_pop", => @model.stashPop()
    atom.workspaceView.command "atomatigit:hard_reset_to_commit", => @model.selection().confirmHardReset()
    atom.workspaceView.command "atomatigit:create_branch", => @model.initiateCreateBranch()
    atom.workspaceView.command "atomatigit:git_command", => @model.initiateGitCommand()
    ...
    atom.workspaceView.command "atomatigit:commit_log", => @showCommits()
